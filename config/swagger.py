...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version='v1',
        description="API для трекинга привычек с Telegram-напоминаниями",
